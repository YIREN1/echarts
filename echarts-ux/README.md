...
A magnificent Niagara module brought to you by yren.
...
```javascript
  require(['/nmodule/echarts/rc/EchartsWidget'], function (EchartsWidget) {
    var widget = new EchartsWidget();
...
minification, and JSDoc generation. Just type: `gradlew :echarts:build`
